...
const config: HardhatUserConfig = {
  ...
  gasReporter: {
    ...
    noColors: true, // Optional: Disable colors in console output (useful for CI)
    token: 'ETH', // Optional: Use a specific token for pricing (default is ETH), // Optional: Display the time spent in the report
